		...
		Transactions: []daemon.MoneroTx{
			{
				...
				TxInfo: daemon.MoneroTxInfo{
					...
					Extra: []byte{1, 185, 132, 49, 141, 70, 78, 86, 180, 67, 175, 34, 213, 248, 128, 71, 6, 6, 67, 81, 114, 163, 186, 215, 25, 102, 226, 164, 186, 229, 209, 138, 128, 2, 9, 1, 144, 209, 60, 76, 125, 146, 34, 210},
		...
		Txs: []daemon.MoneroTx1{
			{
				...
				TxInfo: daemon.MoneroTxInfo{
					...
					Extra: []byte{1, 29, 234, 216, 124, 42, 64, 118, 116, 216, 13, 147, 183, 128, 67, 132, 173, 89, 54, 29, 59, 1, 98, 157, 206, 149, 126, 190, 35, 253, 189, 82, 5, 2, 9, 1, 196, 58, 221, 49, 208, 146, 193, 155},
					RctSignatures: daemon.RctSignature{
						Type:   6,
						TxnFee: 122960000,
						EcdhInfo: []daemon.EcdhInfo{
